                    ...
                    <form method="POST" class="container" id="needs-validation" action="{{ route('jenis-sertifikat.store') }}" novalidate>
                        ...
                        <div class="form-group row col-sm-12">
                            <div class="form-group row col-sm-6">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Kegiatan</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group row col-sm-12">
                            <div class="form-group row col-sm-6">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Pendidikan</label>
                                <div class="col-sm-8">
                                    <select class="form-control" required="" name="partisipasi_id">
                            ...
                            <div class="form-group row col-sm-6">
                                <label for="inputEmail3" class="col-sm-4 col-form-label">Jurusan</label>
                                <div class="col-sm-8">
                                    <select class="form-control" required="" name="partisipasi_id">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Tambah Jenis Sertifikat</button>
                            </div>
                        </div>
                    </form>
                    <script>
