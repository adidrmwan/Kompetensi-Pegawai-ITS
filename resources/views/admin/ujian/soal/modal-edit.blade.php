<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="edit-soal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <form method="POST" class="container" id="needs-validation" action="{{ route('admin-ujian-soal.store') }}" novalidate>
        ...
        <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" id="deskripsi">
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <textarea class="form-control" id="deskripsi2" name="deskripsi" required="" rows="3"></textarea>
              </div>
            </div>
            <div class="form-group row">
