<td>
  ...
  <div class="form-check disabled">
    <label class="form-check-label">
      @if($data->kunci_jawaban == 'pilihan_e')
        <input class="form-check-input" type="radio" id="gridRadios3" value="option3" disabled checked="">{!! $data->pilihan_e !!}
      @else
        <input class="form-check-input" type="radio" id="gridRadios3" value="option3" disabled>{!! $data->pilihan_e !!}
      @endif
    </label>
  </div>
</td>